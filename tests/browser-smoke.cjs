...
async function main() {
  ...
  try {
    ...
    console.log('Browser smoke passed: 7 progressive levels, endpoint retract, feature gates, road grades, bottom inspector, signals, save/load, commute report and responsive layout.');
  } finally {
