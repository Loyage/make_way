...
test('serves only game assets with appropriate MIME types and security headers', async t => {
  ...
  for(const [url,type] of [['/','text/html'],['/index.html','text/html'],['/manual.html','text/html'],['/style.css','text/css'],['/built-in-levels.json','application/json'],['/levels/road-basics/chapter.json','application/json'],['/levels/city-control/bus-school.json','application/json'],['/level-catalog.js','text/javascript'],['/core-geometry.js','text/javascript'],['/core-bus.js','text/javascript'],['/core.js','text/javascript'],['/core-campaign.js','text/javascript'],['/game-results.js','text/javascript'],['/game-effects.js','text/javascript'],['/game-canvas.js','text/javascript'],['/game-bootstrap.js','text/javascript'],['/game.js?v=2','text/javascript']]) {
